...
public class favoris extends AppCompatActivity {
    ...
    * */
    ...
    public void initialisations() {
        ...
        ArrayAdapter<String> adapterDrawerItems = new ArrayAdapter<String>(favoris.this,
        ...
        adapterBarsRows = new BarAdapter(favoris.this, barsRows);
    ...
    /**
     * Génère les items dans la liste des favoris
     *
     * @return ArrayList des items de type BarRow
     * (informations par bars à afficher dans la ListView de l'activité favoris)
     */
    private List<BarRow> genererItemsBars() {
        List<BarRow> barsRows = new ArrayList<BarRow>();
        List<Bar> favorisBDD = barDAO.getAllFavoris();
    ...
    private void selectItem(int position) {
        switch(position) {
            case 0:
                Intent accueil = new Intent(favoris.this, accueil.class);
                startActivity(accueil);
                break;
            case 1:
                Intent favoris = new Intent(favoris.this, favoris.class);
